...
public class DebugLogs implements Process {
    ...
    private String html() {
        ...
        return "<!doctype html><html lang=\"zh-CN\"><head><meta charset=\"utf-8\">"
                ...
                + "<div class=\"category-row\"><nav class=\"tabs\" aria-label=\"日志分类\"><button class=\"chip on\" data-mode=\"all\" aria-pressed=\"true\">全部</button><button class=\"chip\" data-mode=\"api\">站源</button><button class=\"chip\" data-mode=\"diagnostic\">音视频诊断</button><button class=\"chip\" data-mode=\"console\">Console</button><button class=\"chip\" data-mode=\"player\">播放</button><button class=\"chip\" data-mode=\"proxy\">代理</button><button class=\"chip\" data-mode=\"webhome\">WebHome</button><button class=\"chip\" data-mode=\"webview\">WebView</button><button class=\"chip\" data-mode=\"pan\">网盘</button><button class=\"chip\" data-mode=\"server\">服务</button><button class=\"chip\" data-mode=\"sync\">同步</button><button class=\"chip\" data-mode=\"startup\">启动</button><button class=\"chip\" data-mode=\"error\">错误</button></nav><button id=\"search-toggle\" aria-expanded=\"false\" aria-controls=\"search-panel\">搜索</button></div></header>"
