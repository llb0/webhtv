...
public final class PlayerOsdDialog extends DialogFragment {
    ...
    private class OptionAdapter extends RecyclerView.Adapter<OptionAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
            ...
            holder.binding.vodVisible.setNextFocusLeftId(R.id.vodVisible);
            holder.binding.vodVisible.setNextFocusRightId(R.id.liveVisible);
            holder.binding.liveVisible.setNextFocusLeftId(R.id.vodVisible);
            holder.binding.liveVisible.setNextFocusRightId(R.id.liveVisible);
        }
        ...
        private void requestFocus(int position, boolean allowScroll) {
            ...
            if (!holder.binding.vodVisible.requestFocus()) binding.recycler.requestFocus();
        }
